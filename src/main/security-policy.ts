...
const hasSafeUrlShape = (url: URL): boolean => url.username === "" && url.password === "" && url.hash === ""

export const isTrustedRendererUrl = (rawUrl: string, policy: RendererLocationPolicy): boolean => {
...
export const createWillNavigateHandler =
...
export const createWindowOpenHandler =
  (openExternal: OpenExternal, onOpenError: (cause: unknown) => void) =>
